...
import com.raccoontruck.startup.ObjectMapperUtils;
import com.raccoontruck.startup.Role;
import com.raccoontruck.startup.RoleDTO;
...
public class JwtTokenProvider {
    ...
    public String createTokenFromDTO(String username, List<RoleDTO> roles) {
        return createToken(username, ObjectMapperUtils.mapAll(roles, Role.class));
    }
