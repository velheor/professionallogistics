package com.startup.raccoontruck.service;

import com.startup.raccoontruck.domain.Role;
    ...
    private void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())) {
            String message = String.format(
                    "Hello, %s! \n" +
                            "Welcome to RaccoonTruck. Please, visit next link: http://localhost:8080/activate/%s",
                    user.getUsername(),
