            ...
            <div class="col-md-3" style="margin: auto">
                    ...
                    <div class="form-check">
                        <div class="col-md-12">
                            ...
                            <label class="form-check-label" for="driverRoleRadio">
                                <h5>Driver</h5>
                                <p style="font-size: 14px"> You own your vehicle and have authority to book your own loads for you or your fleet.</p>
                            </label>
                        </div>
                    </div>
                    <div class="form-check">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <#if !isRegisterForm><a style="margin-top: 65px; font-size: smaller; font-weight: bold"  href="/registration"  class="btn btn-light active btn-block"
                                                role="button"
                                                aria-pressed="true">Create your RaccoonTruck account</a></#if>
                        <#if !isRegisterForm><p style="margin-top: -58px; margin-left: 70px; font-size: 12px; color: dimgray">New to RaccoonTruck?</p></#if>
